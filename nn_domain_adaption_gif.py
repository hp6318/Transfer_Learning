...
def animate(epoch, src, target, scatters,decay_rate):
    ...
    sc=plt.scatter(src[epoch][:n, 0], src[epoch][:n, 1],color='r',label='Src_class_0',marker='o')
    sc=plt.scatter(src[epoch][n:, 0], src[epoch][n:, 1],color='r',label='Src_class_1',marker='x')

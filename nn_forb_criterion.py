...
def plot(src,target,title,idx):
    ...
    if title=='aligned Vs Before' or title=='aligned' or title =='aligned_greedy_forb_0' or title =='aligned_greedy_forb_1' or title =='aligned_greedy_forb_2' or title =='aligned_greedy_forb_3' or title =='aligned_greedy_mse_0' or title =='aligned_greedy_mse_1' or title =='aligned_greedy_mse_2' or title =='aligned_greedy_mse_3':
